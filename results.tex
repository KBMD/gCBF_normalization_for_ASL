...
SPM analyses of visual stimulation found significant clusters even without normalization, though results were stronger with normalization (see Table and Supplemental Data).
  \textbf{Image set}        & \textbf{peak t} & \textbf{cluster volume}  & \textbf{FDR-corrected p}  \\   
